...
# CORS: only the frontend origin(s) may call this API cross-origin. Default
# covers local Vite dev (`npm run dev` serves on :5173); override per
# environment via the env var.
